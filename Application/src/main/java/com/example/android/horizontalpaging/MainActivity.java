...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class DummySectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ImageView dummyImageView = (ImageView) rootView.findViewById(R.id.myImgView);
            dummyTextView.setText("Hello "+Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 1:
                    dummyImageView.setImageResource(R.drawable.vegeta);
                    return rootView;
                case 2:
                    dummyImageView.setImageResource(R.drawable.ic_launcher);
                    return rootView;
                case 3:
                    dummyImageView.setImageResource(R.drawable.tile);
                    return rootView;
                default:
                    return rootView;
            }
